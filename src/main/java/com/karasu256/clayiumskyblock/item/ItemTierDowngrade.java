...
/**
 * When used on an ore generator block, downgrades its tier by one step (diamond → iron → stone).
 */
public class ItemTierDowngrade extends Item {

    /** Creates the tier downgrade item. */
    public ItemTierDowngrade() {
        setUnlocalizedName("tierDowngrade");
        setMaxStackSize(16);
